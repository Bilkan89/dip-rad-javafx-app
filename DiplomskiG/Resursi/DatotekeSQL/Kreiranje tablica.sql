...
lozinka VARCHAR(8), /*gre�ka nije VARCHAR(8) nego CHAR(8) NOT NULL*/
korisnik_id INTEGER NOT NULL,
...
CREATE TABLE EVIDENTIRANJE.INCIDENT_POCETAK(
...
CONSTRAINT broj_naloga_fk FOREIGN KEY (broj_naloga) REFERENCES EVIDENTIRANJE.INCIDENT_POCETAK(broj_naloga)
);
...
CONSTRAINT trajanje_broj_naloga_fk FOREIGN KEY (broj_naloga) REFERENCES EVIDENTIRANJE.INCIDENT_POCETAK(broj_naloga),
